...
Приложение [Lifehacker] было проанализировано при помощи следующих сервисов и плагинов:
...
Большое количество элементов предполагает большее количество байт для загрузки, а так же и более медленный доступ к DOM элементам из JavaScript. В разметке сайта содержится достаточно большое количество дивов, вложенных друг в друга. Возможно при более тщательной верстке документа удастся избавится от некоторых из них не меняя содержимого страницы.
